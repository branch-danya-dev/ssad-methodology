...
SSAD does not define a universal folder tree. Structure is derived from the real system, its responsibility areas and ownership.
...
1. [`canonical-ownership/`](canonical-ownership/) — where canonical knowledge lives and why one meaningful fact should have one canonical owner;
...
3. [`knowledge-links/`](knowledge-links/) — how to connect local knowledge to dependencies, flows, interfaces, decisions and Change Surface without duplicating canonical truth;
