...
Для этого аналитик устанавливает границы системы, зоны ответственности и владельцев, размещает каноническое знание у соответствующего владельца и связывает локальные модели в целостное представление. В результате понятно, **что известно, откуда это известно, кто за это отвечает, где находится канонический ответ, как знания связаны и что нужно пересмотреть при изменении системы**.
